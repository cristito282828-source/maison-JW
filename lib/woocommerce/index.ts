...
// Path de WPGraphQL. Configurable vía env var (default /graphql).
// Distintos WordPress usan distintos paths: /graphql, /graphqlmaison, /graphql777, etc.
const WPGRAPHQL_PATH = process.env.WPGRAPHQL_PATH || '/graphql';

// Endpoint directo al WordPress (usado en server components).
const directEndpoint = `${domain}${WPGRAPHQL_PATH}`;
